...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-all shadow-sm focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        default:
        ...
        warning:
          "border-transparent bg-yellow-500 text-yellow-900 dark:text-yellow-100 hover:bg-yellow-500/80 hover:shadow-md",
        destructive:
